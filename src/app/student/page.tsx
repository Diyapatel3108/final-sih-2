  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-muted/40 p-8">
      <div className="mb-8 text-center">
        ...
        <h1 className="text-4xl font-bold font-headline text-primary">Student Portal</h1>
        ...
        <CardContent>
          <form onSubmit={handleLogin} className="grid gap-4">
            <div className="grid gap-2">
              ...
              <Input id="email" type="email" placeholder="student@example.com" required disabled={isLoading} defaultValue="student@example.com" />
            </div>
            <div className="grid gap-2">
