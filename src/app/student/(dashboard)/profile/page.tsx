...
export default function StudentProfilePage() {
  ...
  const fallback = student.profile.name.split(' ').map((n: string) => n[0]).join('');
    ...
    <div className="flex min-h-screen w-full flex-col items-center justify-center bg-muted/40 p-4 sm:p-8">
      <Card className="w-full max-w-lg">
        <CardHeader className="items-center text-center">
          ...
          <CardTitle className="text-3xl">{student.profile.name}</CardTitle>
        ...
        <CardContent className="space-y-6 pt-6">
          ...
          <div className="flex items-center p-4 rounded-lg bg-muted/50">
            ...
            <div>
                ...
                <p className="font-semibold">{student.profile.department}</p>
            </div>
          </div>
          <div className="flex items-center p-4 rounded-lg bg-muted/50">
            <Building className="w-5 h-5 mr-4 text-muted-foreground" />
            <div>
                ...
                <p className="font-semibold">{student.profile.contact_no || 'N/A'}</p>
            </div>
          </div>
